      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case CreditosComprasRow:
            return CreditosComprasRow(data);
          case LigaCategoriaRow:
            return LigaCategoriaRow(data);
          case VistaPartidosRow:
            return VistaPartidosRow(data);
          case CreditosTransferenciasRow:
          ...
          case VistaClasesRow:
            return VistaClasesRow(data);
          case VistaTorneosRow:
          ...
          case AmericanoParejasRow:
            return AmericanoParejasRow(data);
          case VistaLigaPartidosRow:
            return VistaLigaPartidosRow(data);
          case TorneoCategoriasRow:
            return TorneoCategoriasRow(data);
          case PagosRow:
