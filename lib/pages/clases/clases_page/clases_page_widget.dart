...
export 'clases_page_model.dart';

class ClasesPageWidget extends StatefulWidget {
  const ClasesPageWidget({super.key});

  @override
  State<ClasesPageWidget> createState() => _ClasesPageWidgetState();
}

class _ClasesPageWidgetState extends State<ClasesPageWidget>
    with TickerProviderStateMixin {
  late ClasesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasesPageModel());
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              context.pushNamed(
                                                'ClaseProfesor',
                                                queryParameters: {
                                                  'profesorId': serializeParam(
                                                    listViewProfesoresRow
                                                        .profesorId,
                                                    ParamType.String,
                                                  ),
                                                }.withoutNulls,
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: FutureBuilder<List<AlumnosRow>>(
                                      future: AlumnosTable().querySingleRow(
                                        queryFn: (q) => q.eq(
                                          'alumnoId',
