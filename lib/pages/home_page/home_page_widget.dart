                                                      ...
                                                      text: TextSpan(
                                                        children: [
                                                          TextSpan(
                                                            text: functions
                                                                .numberRanking(
                                                                    functions.rankingConvert(FFAppState()
                                                                        .UserInfo
                                                                        .ranking),
                                                                    1)
                                                                .toString(),
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            15.0, 0.0, 5.0, 10.0),
                                        child: Text(
                                          'Crea o únete a uno para mejorar tu nivel.',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Roboto',
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            15.0, 0.0, 5.0, 10.0),
                                        child: Text(
                                          'Un continuo desafio al máximo nivel.',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Roboto',
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            15.0, 0.0, 5.0, 10.0),
                                        child: Text(
                                          'Compara tu nivel con el del resto.',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Roboto',
