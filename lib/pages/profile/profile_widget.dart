            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  FutureBuilder<List<CreditosRow>>(
                    future: CreditosTable().querySingleRow(
                      queryFn: (q) => q
                          .eq(
                            'userId',
                            currentUserUid,
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (!snapshot.hasData) {
                        return const LoadingCreditos3Widget();
                      }
                    ...
                    builder: (context) => Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          setState(() {});
                          _model.supaCreditos = await CreditosTable().queryRows(
                            queryFn: (q) => q
                                .eq(
                                  'userId',
                                  currentUserUid,
                          ...
                          if (_model.supaCreditos.isNotEmpty) {
                            await showDialog(
                              context: context,
                                      ...
                                      child: SizedBox(
                                        width:
                                            MediaQuery.sizeOf(context).width *
                                                0.95,
                                        child: TransferirCreditosWidget(
                                          creditosUser:
                                              _model.supaCreditos!.first,
                                        ),
                                      ),
                                    ),
                                  ),
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                ...
                                backgroundColor: FFAppState().Club.colorTrue,
                              ),
                            );
                            _model.isLoading = false;
                            setState(() {});
