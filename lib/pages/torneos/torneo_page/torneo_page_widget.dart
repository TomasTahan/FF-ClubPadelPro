...
class TorneoPageWidget extends StatefulWidget {
  const TorneoPageWidget({
    super.key,
  ...
  @override
  State<TorneoPageWidget> createState() => _TorneoPageWidgetState();
}

class _TorneoPageWidgetState extends State<TorneoPageWidget>
    with TickerProviderStateMixin {
  late TorneoPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TorneoPageModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.isInscrito =
          functions.isInscrito2(_model.supaParejas?.toList(), currentUserUid);
      setState(() {});
    });
