...
import 'americano_inscripcion_model.dart';
export 'americano_inscripcion_model.dart';

class AmericanoInscripcionWidget extends StatefulWidget {
  const AmericanoInscripcionWidget({
    super.key,
  ...
  @override
  State<AmericanoInscripcionWidget> createState() =>
      _AmericanoInscripcionWidgetState();
}

class _AmericanoInscripcionWidgetState extends State<AmericanoInscripcionWidget>
    with TickerProviderStateMixin {
  late AmericanoInscripcionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AmericanoInscripcionModel());
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: (_model.partnerId == null ||
                                      _model.partnerId == '')
                                  ? null
                                  : () {
