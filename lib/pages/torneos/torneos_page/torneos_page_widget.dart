...
class TorneosPageWidget extends StatefulWidget {
  const TorneosPageWidget({super.key});

  @override
  State<TorneosPageWidget> createState() => _TorneosPageWidgetState();
}

class _TorneosPageWidgetState extends State<TorneosPageWidget>
    with TickerProviderStateMixin {
  late TorneosPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TorneosPageModel());
