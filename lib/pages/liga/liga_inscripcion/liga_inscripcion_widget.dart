...
import 'liga_inscripcion_model.dart';
export 'liga_inscripcion_model.dart';

class LigaInscripcionWidget extends StatefulWidget {
  const LigaInscripcionWidget({
    super.key,
  ...
  final List<int>? cateogiras;

  @override
  State<LigaInscripcionWidget> createState() => _LigaInscripcionWidgetState();
}

class _LigaInscripcionWidgetState extends State<LigaInscripcionWidget>
                        ...
                        itemBuilder: (context, listUsersIndex) {
                          ...
                          return Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                _model.partnerId = valueOrDefault<String>(
                                ...
                                _model.partner = valueOrDefault<String>(
                                  SupabaseDashboardGroup.searchUsersCall
                                      .apiNombre(
                                    (_model.apiResultl5y?.jsonBody ?? ''),
                                  )?[listUsersIndex],
