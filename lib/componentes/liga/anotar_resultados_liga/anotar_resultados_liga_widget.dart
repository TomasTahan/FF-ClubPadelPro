...
import 'anotar_resultados_liga_model.dart';
export 'anotar_resultados_liga_model.dart';

class AnotarResultadosLigaWidget extends StatefulWidget {
  const AnotarResultadosLigaWidget({
    super.key,
  ...
  @override
  State<AnotarResultadosLigaWidget> createState() =>
      _AnotarResultadosLigaWidgetState();
}

class _AnotarResultadosLigaWidgetState extends State<AnotarResultadosLigaWidget>
    with TickerProviderStateMixin {
  late AnotarResultadosLigaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AnotarResultadosLigaModel());
